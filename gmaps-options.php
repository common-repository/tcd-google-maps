  <script type="text/javascript">
    ...
    app.controller('GMapsEasyController', function($scope) {
      ...
      if( settings ){
        ...
        $scope.height_m = settings.height_m
      ...
      $scope.$watchGroup(['zoom', 'draggable', 'width', 'fullWidth', 'height', 'height_m', 'apiKey', 'address', 'theme', 'borders', 'centered', 'controls'], function() {
        ...
        $scope.result = [
          ...
          $scope.height + 'px',
          '" height_m="',
          $scope.height_m ? $scope.height_m+'px' : '300px',
          '" api="',
          $scope.apiKey,
          '" theme="',
          $scope.theme,
        ...
        if (currentApiKey !== $scope.apiKey) {
          currentApiKey = $scope.apiKey;
          var gmapsapiurl = "https://maps.googleapis.com/maps/api/js";
          if ($scope.apiKey) {
            gmapsapiurl += "?key=" + $scope.apiKey;
          }
          jQuery("#js-dp-google-map-api").remove()
          jQuery("body").append("<script id='js-dp-google-map-api' src='" + gmapsapiurl + "' async defer></scr" + "ipt>");
        }
  ...
  <div class="wrap" ng-app="GMapsEasyApp" ng-controller="GMapsEasyController" style="-webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
    ...
    <div class="tcd-google-maps-settings">
      ...
      <p><?php _e('Mobile devices will always display the map at 100% width.', 'tcd-google-maps'); ?></p>
      <label><input ng-disabled="fullWidth" type="number" min="0" ng-model="width" style="width:10%" ng-model-options="{ debounce: 1000 }"></label><br/><br/>
    ...
    <div class="tcd-google-maps-settings">
      ...
      <label><span style="min-width: 150px; display: inline-block;"><?php _e('For PC', 'tcd-google-maps'); ?></span><input type="number" ng-model="height" min="0" style="width:10%" ng-model-options="{ debounce: 1000 }"></label><br/><br/>
      <label><span style="min-width: 150px; display: inline-block;"><?php _e('For mobile device', 'tcd-google-maps'); ?></span><input type="number" ng-model="height_m" min="0" style="width:10%" ng-model-options="{ debounce: 1000 }"></label>
    </div>
    ...
    <div class="tcd-google-maps-settings">
      ...
      <p><?php _e('Adjust the zoom level. leftmost will show the whole world, righmost just the building.', 'tcd-google-maps'); ?></p>
